...
import { hook as hook46 } from '../concurrent-cargo-build-guard/index.mts'
import { hook as hook47 } from '../consumer-grep-nudge/index.mts'
import { hook as hook48 } from '../convo-prose-nudge/index.mts'
import { hook as hook49 } from '../copy-on-select-hint-nudge/index.mts'
import { hook as hook50 } from '../cross-repo-guard/index.mts'
import { hook as hook51 } from '../dated-citation-guard/index.mts'
import { hook as hook52 } from '../default-branch-guard/index.mts'
import { hook as hook53 } from '../defer-to-script-nudge/index.mts'
import { hook as hook54 } from '../denied-domain-reference-guard/index.mts'
import { hook as hook55 } from '../dep-derived-source-nudge/index.mts'
import { hook as hook56 } from '../dirty-lockfile-nudge/index.mts'
import { hook as hook57 } from '../dirty-worktree-stop-guard/index.mts'
import { hook as hook58 } from '../disowned-dirt-guard/index.mts'
import { hook as hook59 } from '../dogfood-cascade-nudge/index.mts'
import { hook as hook60 } from '../dont-blame-nudge/index.mts'
import { hook as hook61 } from '../dont-stop-mid-queue-nudge/index.mts'
import { hook as hook62 } from '../drift-check-nudge/index.mts'
import { hook as hook63 } from '../enqueue-dont-pivot-nudge/index.mts'
import { hook as hook64 } from '../enterprise-push-nudge/index.mts'
import { hook as hook65 } from '../error-message-quality-nudge/index.mts'
import { hook as hook66 } from '../excuse-detector/index.mts'
import { hook as hook67 } from '../file-size-nudge/index.mts'
import { hook as hook68 } from '../fixer-foreign-edits-nudge/index.mts'
import { hook as hook69 } from '../fixes-need-tests-nudge/index.mts'
import { hook as hook70 } from '../follow-direct-imperative-nudge/index.mts'
import { hook as hook71 } from '../generic-export-name-nudge/index.mts'
import { hook as hook72 } from '../gh-token-hygiene-guard/index.mts'
import { hook as hook73 } from '../git-config-write-guard/index.mts'
import { hook as hook74 } from '../git-identity-drift-nudge/index.mts'
import { hook as hook75 } from '../gitmodules-comment-guard/index.mts'
...
export const DISPATCH_TABLE: Record<string, readonly DispatchHookEntry[]> = {
  ...
  'PostToolUse': [
    ...
    { name: 'dep-derived-source-nudge', check: hook55.check, tools: ['Edit', 'MultiEdit', 'Write'] },
  ...
  'PreToolUse': [
    ...
    { name: 'concurrent-cargo-build-guard', check: hook46.check, tools: ['Bash'] },
    { name: 'consumer-grep-nudge', check: hook47.check, tools: ['Edit', 'Write', 'MultiEdit'] },
    { name: 'convo-prose-nudge', check: hook48.check, tools: ['Bash'] },
    { name: 'cross-repo-guard', check: hook50.check, tools: ['Edit', 'Write', 'MultiEdit'] },
    { name: 'dated-citation-guard', check: hook51.check, tools: ['Edit', 'Write', 'MultiEdit'] },
    { name: 'default-branch-guard', check: hook52.check, tools: ['Bash'] },
    { name: 'defer-to-script-nudge', check: hook53.check, tools: ['Edit', 'MultiEdit', 'Write'] },
    { name: 'denied-domain-reference-guard', check: hook54.check, tools: ['Edit', 'Write', 'MultiEdit'] },
    { name: 'fixer-foreign-edits-nudge', check: hook68.check, tools: ['Bash'] },
    { name: 'fixes-need-tests-nudge', check: hook69.check, tools: ['Bash'] },
  ...
  'Stop': [
    ...
    { name: 'dirty-worktree-stop-guard', check: hook57.check, tools: undefined },
    { name: 'disowned-dirt-guard', check: hook58.check, tools: undefined },
    { name: 'dogfood-cascade-nudge', check: hook59.check, tools: undefined },
    { name: 'dont-blame-nudge', check: hook60.check, tools: undefined },
    { name: 'dont-stop-mid-queue-nudge', check: hook61.check, tools: undefined },
    { name: 'drift-check-nudge', check: hook62.check, tools: undefined },
    { name: 'enqueue-dont-pivot-nudge', check: hook63.check, tools: undefined },
    { name: 'error-message-quality-nudge', check: hook65.check, tools: undefined },
    { name: 'excuse-detector', check: hook66.check, tools: undefined },
    { name: 'file-size-nudge', check: hook67.check, tools: undefined },
